...
import com.hsbc.electronics.exception.BaseAbstract;
import com.hsbc.electronics.exception.ResourceNotFoundException;
...
public class BaseController extends BaseAbstract implements MessageSourceAware {
    ...
    public ResponseEntity<Map<String, Object>> resourcesNotFoundHandler(ResourceNotFoundException resourceNotFoundException, HttpServletRequest req, Exception e) {
    ...
    private Map<String, Object> getmessage(String errorCode) {
        ...
        logger.info(messageSource.getMessage(errorCode, null, Locale.US), HttpStatus.NOT_FOUND.value(), HttpStatus.NOT_FOUND);
        return map;
    }
